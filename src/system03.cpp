...
//	motor.sendSignal(RPI_L6470_SIG_MAXSPEED, 0x1);
//	motor.sendSignal(RPI_L6470_SIG_ACCEL, 0x05);
//	motor.sendSignal(RPI_L6470_SIG_DECEL, 0x05);
...
void system03::update(const ofVec3f target)
{
	...
	if (goDefault){//初期位置
		...
		motor.enableAllMotor();
		motor_pos[0] =  eyes.arm[0].rootPan / 1.8f * 128 + center;//1.8何？
		motor_pos[1] = -eyes.arm[1].rootPan / 1.8f * 128 + center;
		motor_pos[2] =  eyes.arm[2].rootPan / 1.8f * 128 + center;
